...
public class AnalizadorLexico {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String Acumulado = "";
        int SaltosLinea = 1;
        String RutaTxt = "C:/Users/robol/Documents/TextPrueba.txt";
        PushbackReader Lector = new PushbackReader(new FileReader(RutaTxt));
            ...
            if (EstaEnAlfabeto((char) CaracterLeido)) {
                ...
                do {
                    ...
                    if (EstaEnAlfabeto((char) CaracterLeido) || EsteaEnDigito((char) CaracterLeido)) {
                        ...
                        if (palabrasReservadas.get(Acumulado) != null) {
                            AnalizadorLexico.CrearNodo("Palabra reservada "+Acumulado, "Token "+(palabrasReservadas.get(Acumulado)), SaltosLinea);
                ...
                if ('*' == ((char) CaracterLeido)) {
                    ...
                    do {
                        ...
                        if (((char) CaracterLeido) == '*') {
                            ...
                            else{Acumulado = Acumulado + ((char) CaracterLeido);}
                        }
                        if (CaracterLeido == -1) {
        ...
        AnalizadorLexico.RecorrerLista();
